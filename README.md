...
- 💼 **Занятость:** Работаю в компании ПАО «**МегаФон**», занимаюсь разработкой backend'a для Геоаналитических сервисов IoT.
- 🌱 **Опыт:** У меня более 4-x лет опыта в разработке Python-приложений.
